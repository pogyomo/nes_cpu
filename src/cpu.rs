...
use crate::opcode::{AddressingMode, OpcodeInfo, OPCODE_TABLE, Mnemonic};
use crate::register::{Register, Status};
...
impl Cpu {
    ...
    pub fn step(&mut self) {
        ...
        let (addr, mode) = self.fetch_address(info);
...
impl Cpu {
    ...
    fn fetch_address<'a>(&mut self, info: &'a OpcodeInfo) -> (u16, &'a AddressingMode) {
